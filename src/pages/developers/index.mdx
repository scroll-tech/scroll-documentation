...
- For the essentials: Check out the [Developer Quickstart](./developer-quickstart)
- For a tutorial walking through deploying your first smart contract on Scroll, read our [contract deployment tutorial](./contract-deployment-tutorial)
- We also have a number of [integrations](./integrations) and [deployed contract addresses](./alpha-testnet-contracts) to build on.
