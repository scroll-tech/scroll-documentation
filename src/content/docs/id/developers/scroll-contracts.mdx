...
section: developers
date: Last Modified
title: "Kontrak Scroll"
lang: "id"
permalink: "developers/scroll-contracts"
whatsnext: { "Perbedaan Ethereum & Scroll": "/id/developers/ethereum-and-scroll-differences" }
...
Dalam artikel ini, Anda akan menemukan alamat kontrak yang berguna untuk Scroll dan protokol yang umum digunakan. Lihat bagian di bawah ini untuk info [Scroll Sepolia](#scroll-sepolia-testnet).

## Info Jaringan

Gunakan tabel di bawah ini untuk mengonfigurasi alat Ethereum Anda ke jaringan utama Scroll.
...
- Biaya Transaksi Vault: [`0x5300000000000000000000000000000000000005`](https://scrollscan.com/address/0x5300000000000000000000000000000000000005)

## Protocols pada Scroll Mainnet
...
<Aside type="note" title="">
  Token-token yang dibawa dari Ethereum Mainnet menggunakan `Native Bridge` dapat ditemukan dan ditambahkan ke repositori [token-list](https://github.com/scroll-tech/token-list).
</Aside>
...
Gunakan tabel di bawah ini untuk mengkonfigurasi alat Ethereum Anda ke Testnet Scroll Sepolia.
...
- Vault Biaya transaksi: [`0x5300000000000000000000000000000000000005`](https://sepolia.scrollscan.com/address/0x5300000000000000000000000000000000000005)
...
Kunjungi ini [Github gist](https://gist.github.com/dghelm/7fe68f0a524f30846e1142721c081d84).
...
<Aside type="note" title="">
  Token-token yang dibawa dari Ethereum Sepolia menggunakan `Native Bridge` dapat ditemukan dan ditambahkan ke repositori
  [token-list](https://github.com/scroll-tech/token-list/tree/sepolia) di `sepolia` branch.
</Aside>
