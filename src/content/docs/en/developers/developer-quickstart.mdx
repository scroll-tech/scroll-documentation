...
Since Scroll is bytecode equivalent to the EVM, you’ll just need to point your favorite builder tools at a Scroll RPC Provider.
...
To configure your frontend, you need to add the Scroll Sepolia Testnet as a network option and then select it as default.
