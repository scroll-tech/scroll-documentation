...
You can request testnet ETH via the official Scroll telegram faucet bot by accepting [this invite](https://t.me/+GbChaKi9K_FmYzcy). Once on the faucet telegram group chat, send your wallet address on a `/drop YOUR_ETHEREUM_ADDRESS` command and the bot will automatically send some funds to you.
