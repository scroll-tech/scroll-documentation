...
In this article you'll find useful contract addresses for Scroll and commonly used protocols. Addresses for the retired [Scroll Sepolia](#scroll-sepolia-testnet) testnet are kept below for historical reference.
...
<Aside type="caution" title="Scroll Sepolia is shut down">
  Scroll Sepolia was shut down after July 30th, 2026. The network no longer produces blocks and its RPC and bridge
  endpoints are gone. The addresses below are kept for historical reference only — do not use them for new work.
</Aside>
...
- Gas Oracle (deployed on Sepolia)
  ...
  - L1 Message Queue V2 With Gas Price Oracle: [`0xA0673eC0A48aa924f067F1274EcD281A10c5f19F`](https://sepolia.etherscan.io/address/0xA0673eC0A48aa924f067F1274EcD281A10c5f19F)
