...
Let’s start by deploying the target smart contract. We will use the Greeter smart contract for this
...
- `scrollMessengerAddress`: This will depend on where you deployed the `GreeterOperator` contract. If you deployed it on L1 use `0x50c7d3e7f7c656493D1D76aaa1a836CedfCBB16A`. If you deployed on L2 use `0xBa50f5340FB9F3Bd074bD638c9BE13eCB36E603d`.
