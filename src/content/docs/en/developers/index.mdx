...
Yes. Please refer to our list of [Unofficial Faucets](https://docs.scroll.io/en/user-guide/faucet/) on both Sepolia and Scroll Sepolia. You can also use [ethfaucet.com](https://ethfaucet.com), which provides 0.1 Scroll Sepolia ETH daily after a one-time [BringID](https://bringid.org) verification. Remember, you can either receive Scroll Sepolia ETH directly or through the [Sepolia Testnet Bridge](https://sepolia.scroll.io/bridge).
