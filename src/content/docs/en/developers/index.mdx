...
**What were the network parameters for Scroll Sepolia Testnet?**

<Aside type="caution" title="Scroll Sepolia is shut down">
  Scroll Sepolia was shut down after July 30th, 2026. The RPC endpoint below no longer responds. These parameters are
...
Sepolia : https://snapshot.scroll.io/sepolia/mpt/latest.tar (Scroll Sepolia was shut down after July 30th, 2026 — kept for historical reference)
...
**I have a question about my node or developing on Scroll. What should I do?**
