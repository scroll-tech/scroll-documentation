...
Most precompiled contracts are supported. For a complete and up-to-date list of supported precompiles and any differences from Ethereum, see [rollup.codes/scroll](https://www.rollup.codes/scroll). Calls to unsupported precompiled contracts will revert.
