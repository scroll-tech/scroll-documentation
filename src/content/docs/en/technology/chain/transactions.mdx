...
- This type of transactions doesn't pay [L2 fee](/developer/transaction-fees-on-scroll#l1-fee) [L1 fee](/developer/transaction-fees-on-scroll#l1-fee). The L2 fee is already paid when user submit the transactions on L1. Because the data of `L1MessageTx` transactions was already stored in the L1 bridge contract, we don't need to submit the data to L1 again.
