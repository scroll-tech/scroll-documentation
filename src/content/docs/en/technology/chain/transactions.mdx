...
- [EIP-2930](https://eips.ethereum.org/EIPS/eip-2930) Access List Transaction (Type 1): Supported since the [Curie upgrade](/technology/overview/scroll-upgrades/curie-upgrade).
