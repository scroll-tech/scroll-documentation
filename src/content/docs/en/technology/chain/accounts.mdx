...
lang: "en"
permalink: "technology/chain/accounts"
excerpt: ""
---
...
- `storageRoot`: The root hash of the storage trie. Since Scroll uses the [zkTrie](/-8m3LNJyRrSV3lB2nxG8lQ) for the storage trie, the `storageRoot` stores the Poseidon hash digest in a 256-bit integer.
