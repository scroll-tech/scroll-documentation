...
<Aside type="note" title="Current Proving System">
Since the [Euclid upgrade](/en/technology/overview/scroll-upgrades/euclid-upgrade), Scroll uses the **OpenVM prover** built on a general-purpose RISC-V zkVM. This page explains the conceptual foundations of zkEVM technology. For details on Scroll's current proving architecture, see the [Proof Generation](/en/technology/prover/proof-generation) page.
</Aside>
...
<Aside type="tip" title="State Commitment">
Scroll uses Ethereum's native [Merkle-Patricia Trie](https://ethereum.org/en/developers/docs/data-structures-and-encoding/patricia-merkle-trie/) (MPT) for state commitment, ensuring full compatibility with the Ethereum ecosystem.
</Aside>
