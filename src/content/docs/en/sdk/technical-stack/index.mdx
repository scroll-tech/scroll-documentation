...
2. A docker image for building the correct configuration files for these services *(see [Smart Contracts](/en/sdk/technical-stack/contracts))*
3. An Ansible playbook for setting up a zk prover *(see [Proof Generation](/en/sdk/technical-stack/proof-generation))*
4. Example config files for various customizations *(see [Customization](/en/sdk/technical-stack/customization))*
