...
Visit our bridge app on [Sepolia](https://sepolia.scroll.io/bridge) or [Mainnet](https://scroll.io/bridge) to get started![^thanks-hop] The Bridge supports both **Deposit** and **Withdraw** operations, allowing users to trustlessly move assets from L1 to L2.
