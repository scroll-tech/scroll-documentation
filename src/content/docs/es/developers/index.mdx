...
<ToggleElement anchor="throughput">
  <div slot="title">Rendimiento - Scroll crea un espacio de bloques más seguro para Ethereum.</div>
  <p>
...
<ToggleElement anchor="cost">
  <div slot="title">Coste - Scroll ahorra a los usuarios los gastos de gas.</div>
  <p>
...
<ToggleElement anchor="alignment">
  ...
  <p>
    ...
    el roadmap que estamos construyendo. Creemos en el software de código abierto y colaboramos estrechamente con el 
...
<ToggleElement anchor="community">
  ...
  <p>
    Conocemos los retos de construir abiertamente y conseguir la participación de los usuarios antes del lanzamiento de la mainnet. 
