...
excerpt: "Thông tin mạng và địa chỉ hợp đồng bạn cần để bắt đầu với Scroll Sepolia Testnet."
---
...
Trong bài viết này, bạn sẽ tìm thấy các địa chỉ hợp đồng hữu ích cho Scroll và các giao thức thường được sử dụng. Xem phần bên dưới để biết thông tin về [Scroll Sepolia](#scroll-sepolia-testnet).
...
<Aside type="note" title="">
  Các token được bắc cầu từ Ethereum Mainnet sử dụng cầu nối gốc có thể được tìm thấy trên và thêm vào [token-list](https://github.com/scroll-tech/token-list) repo.
</Aside>
