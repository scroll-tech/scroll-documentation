...
```mermaid
stateDiagram
    Bước --> Trạng thái Bước
    Bước --> Quản lý ô
    Người xây dựng Ràng buộc --> Quản lý ô
    Quản lý ô --> Hệ thống Chứng minh(Halo2)
    Trạng thái Bước --> Trạng thái Thực thi
    Trạng thái Bước --> ngữ cảnh bước
    Trạng thái Thực thi --> Người xây dựng Ràng buộc
    ngữ cảnh bước --> Người xây dựng Ràng buộc
