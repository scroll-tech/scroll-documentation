...
section: developers
date: Last Modified
title: "Contratti di Scroll"
lang: "it"
permalink: "developers/scroll-contracts"
whatsnext: { "Differenze tra Scroll ed Ethereum": "/it/developers/ethereum-and-scroll-differences" }
...
In questo articolo troverai gli indirizzi utili dei contratti per Scroll e i protocolli comunemente utilizzati. Consulta la sezione sottostante per informazioni su [Scroll Sepolia](#scroll-sepolia-testnet).

## Informazioni sulla Rete

Utilizza la tabella seguente per configurare i tuoi strumenti Ethereum per il mainnet di Scroll.
...
- L1 Rollup (Catena di Scroll): [`0xa13BAF47339d63B743e7Da8741db5456DAc1E556`](https://etherscan.io/address/0xa13BAF47339d63B743e7Da8741db5456DAc1E556)
...
- Gas Oracle (deployed on Mainnet)
  - L2 Gas Oracle (*prossimamente deprecato*): [0x987e300fDfb06093859358522a79098848C33852](https://etherscan.io/address/0x987e300fDfb06093859358522a79098848C33852)
  - *dopo l'aggiornamento del ponte di febbraio '24*
    - L2 Message Queue con Gas Price Oracle: [0x0d7E906BD9cAFa154b048cFa766Cc1E54E39AF9B](https://etherscan.io/address/0x0d7E906BD9cAFa154b048cFa766Cc1E54E39AF9B)
...
## Protocolli sulla Scroll Mainnet
...
Scroll è disponibile nell'[app Safe ufficiale](https://app.safe.global), e il servizio API delle transazioni è disponibile su https://safe-transaction-scroll.safe.global/.

<Aside type="caution" title="Transizione a Safe">
Dal 20 giugno, Scroll Mainnet non sarà più supportato su [safe.scroll.xyz](https://safe.scroll.xyz)!
I safes creati saranno automaticamente disponibili nell'app ufficiale, ma i dati locali (rubrica degli indirizzi, impostazioni e variabili) devono essere trasferiti manualmente utilizzando la funzionalità di Esporta/Importa disponibile [qui](https://safe.scroll.xyz/settings/data).
Inoltre, se hai transazioni non completate su Mainnet, ti invitiamo a finalizzarle prima del 20 giugno!
</Aside>
...
<Aside type="note" title="">
  I bridged token dall'Ethereum Mainnet utilizzando il bridge nativo possono essere trovati e aggiunti al repository [token-list](https://github.com/scroll-tech/token-list).
</Aside>
...
### Informazioni sulla Rete
Utilizza la tabella qui sotto per configurare i tuoi strumenti Ethereum alla Testnet Scroll Sepolia.
...
<ToggleElement anchor="sepolia-additional-infra">
  <div slot="title">Scroll Sepolia RPCs and Infra Addizionali</div>
...
Vedi qua [Github gist](https://gist.github.com/dghelm/7fe68f0a524f30846e1142721c081d84).
...
Puoi usare Safe su Scroll [here](https://safe.scroll.xyz/),  e le API per il servizio di trasferimento sono su https://transaction-sepolia.safe.scroll.xyz.
...
<Aside type="note" title="">
  I token ponticati da Ethereum Sepolia utilizzando il ponte nativo possono essere aggiunti alla repository [token-list](https://github.com/scroll-tech/token-list/tree/sepolia) nel ramo `sepolia`.
