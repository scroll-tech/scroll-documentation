...
excerpt: "Scroll Sepolia Testnet kullanmaya başlayabilmeniz gereken ağ bilgileri ve sözleşme adresleri."
---
...
| Ağ Adı             | Scroll                                             | Ethereum Mainnet                                     |
| ------------------ | -------------------------------------------------- | ---------------------------------------------------- |
...
- Gas Oracle (Mainnet'te konuşlandırıldı)
...
## Scroll Mainnet'teki Protokoller
...
<Aside type="note" title="">
  Yerel köprüyü kullanan Ethereum Mainnet'ten köprülenmiş tokenler, [token-list](https://github.com/scroll-tech/token-list) deposunda bulunabilir ve buraya eklenebilir.
</Aside>
...
Ethereum araçlarınızı Scroll Sepolia Testnet'e yapılandırmak için aşağıdaki tabloyu kullanın.
