...
Bu örnekte, Sepolia veya Scroll üzerinde bir kukla akıllı sözleşme başlatacağız ve onunla karşı zincirden etkileşime geçeceğiz. Hem Sepolia'da hem de Scroll'da dağıtılmış olan "ScrollMessenger"ı kullanacağız.
