...
L2'den L1'e bir işlem geçtiğinde, L1 üzerinde ek bir "para çekimi gerçekleştirme işlemi" gönderilmelidir. Bunu yapmak için L1 Scroll Messenger'da 'relayMessageWithProof'u çağırmalısınız.
