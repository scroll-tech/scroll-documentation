...
whatsnext: { "Scroll Habercisi ile Zincirler Arası Etkileşim": "/tr/developers/guides/scroll-messenger-cross-chain-interaction/" }
---
...
<Aside type="tip" title="Testnet ETH'niz var mı?">
...
5. Sözleşmeyi Scroll Sepolia Testnet'te dağıtmak için `yarn deploy:scrollTestnet'i çalıştırın.
...
Scroll Sepolia Testnet'e katıldığınız ve geliştirdiğiniz için teşekkür ederiz! Herhangi bir sorunla karşılaşırsanız [Discord'umuza](https://discord.gg/scroll) katılın ve "#testnet-devs" kanalından bize sorun.
