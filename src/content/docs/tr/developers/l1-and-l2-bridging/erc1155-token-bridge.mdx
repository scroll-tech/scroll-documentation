...
whatsnext: { "Scroll Habercisi": "/tr/developers/l1-and-l2-bridging/the-scroll-messenger/" }
excerpt: "L1'den L2'ye ERC1155 köprülenmesi L1ERC1155Ağ Geçidi aracılığıyla yapılır."
---
...
ERC1155'in L1'den L2'ye köprülenmesi L1ERC1155Ağ Geçidi aracılığıyla yapılır. ERC721 köprülemeye benzer şekilde, bir yönlendirici kullanmak yerine doğrudan Ağ Geçidi üzerinde 'depositERC1155' fonksiyonunu kullanıyoruz.
