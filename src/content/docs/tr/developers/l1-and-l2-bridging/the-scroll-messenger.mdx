...
section: developers
date: Last Modified
title: "The Scroll Habercisi"
lang: "tr"
permalink: "developers/l1-and-l2-bridging/the-scroll-messenger"
whatsnext: { "Scroll'de İşlem Ücretleri": "/tr/developers/transaction-fees-on-scroll/" }
excerpt: "L1 ve L2 arasında herhangi bir mesaj geçişi sağlayan Scroll Haberci belgeleri."
---

import Aside from "../../../../../components/Aside.astro"

Scroll Haberci sözleşmeleri, L1'den L2'ye veya L1'den L2'ye herhangi bir mesajın gönderilmesine izin verir. Bu, başka bir zincirdeki fonksiyonların güvenli ve izinsiz bir şekilde yürütülmesine olanak tanır. L1'den L2'ye mesaj göndermek için L1'de dağıtılmış olan 'L1ScrollMessenger' mesajlaşma akıllı sözleşmesini kullanın. L2'den L1'e mesaj göndermek için L2'de dağıtılmış olan 'L2ScrollMessenger' sözleşmesini kullanın.

<Aside type="caution" title="">
  L1 ve L2'de dağıtılmış olan **Scroll Habercisi** aracılığıyla bir işlem gönderilirken; sonuçlanan işlemin göndereni ("CALLER" veya "msg.sender"), alıcı zincirde dağıtılmış olan Haberci Sözleşmesi'nin adresi olacaktır.
  <br />
