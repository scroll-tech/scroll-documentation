...
Scroll'da işlem ücretleri, destek verdiği katmana(Katman 1) göre oldukça düşüktür. Kullanıcılar ve geliştiriciler için Scroll'daki işlem ücretleri, Ethereum ana ağında olduğuna benzer şekilde çalışıyor gibidir. Mevcut araçlar, cüzdanlar ve kodlar da büyük ihtimalle oldukları gibi çalışacaklardır. Ancak cüzdanda gösterilen işlem ücreti, kullanılan yazılım Scroll'un ücret hesaplamalarından özellikle haberdar olmadığı sürece resmin tamamını içermeyecektir.
