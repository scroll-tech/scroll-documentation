...
Testnetimizle etkileşimde bulunmak için öncelikle _Sepolia Testnet_'te testnet ETH almanız gerekmektedir. Daha sonra _Sepolia Testnet_ üzerinden _Scroll Sepolia Testnet_'e köprüleme yapabilirsiniz.
