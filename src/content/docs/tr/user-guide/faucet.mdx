...
Test ağımız ile etkileşimde bulunmak için öncelikle _Sepolia Test ağında_ test ağı ETH'i almanız gerekmektedir. Daha sonra _Sepolia Test ağı_ üzerinden _Scroll Sepolia Test ağına_ köprüleme yapabilirsiniz.
