...
Başlamak için [Köprü](https://sepolia.scroll.io/bridge) uygulamamızı ziyaret edin![^thanks-hop] Köprü, **Yatırım** ve **Çekim** işlemlerini destekler ve kullanıcılara Sepolia Test Ağı'ndan Scroll Sepolia Test Ağı'na varlıkları güvenle taşıma imkanı sunar.
...
## Sepolia'dan Scroll Sepolia'ya Yatırın

### Talimatlar

1. İlk olarak, [Scroll Köprüsü'ne](https://sepolia.scroll.io/bridge)'e gidin ve "Cüzdanı Bağla" düğmesine basın.
