...
Yatırımların Scroll üzerinde kullanılabilir hale gelmesi 15 dakikaya kadar sürebilir.

Çekimler, çekimin tamamlanmasından sonra Sepolia'da ikinci bir etkileşim gerektirmesinden dolayı daha uzun sürebilir.

:::caution[Köprü işlemi için uzun süredir bekliyor musunuz?]
Yukarıdaki zaman tahminleri, normal ağ davranışı ve etkinlik seviyeleri içindir. L2 bloğunda sıralı L1 işlemlerini sınırlı sayıda işlediğimizden, köprülenen mesajların olağanüstü ağ kullanımı zamanlarında Scroll'de dahil edilmesi daha uzun sürebilir.
:::
...
1. İlk olarak, [Scroll Bridge](https://sepolia.scroll.io/bridge)'e gidin ve "Cüzdanı Bağla" düğmesine basın.
...
1. Sepolia'dan Scroll Sepolia'ya transfer etmek istediğiniz tokeni seçin. İlk kez köprü kullanıyorsanız, "ETH"yi deneyin.
...
1. **Scroll Sepolia**'dan **Sepolia**'ya aktarmak istediğiniz tokeni seçin. İlk kez köprü kullanıyorsanız, "ETH"yi deneyin.
