...
excerpt: "Sepolia'dan varlıkları köprülemeye başlamak için portal köprü uygulamasına gidin."
---
...
Başlamak için [Köprü](https://sepolia.scroll.io/bridge) uygulamamızı ziyaret edin![^thanks-hop] Köprü, **Yatırım** ve **Çekim** işlemlerini destekler ve kullanıcılara Sepolia Testnet'ten Scroll Sepolia Testnet'e varlıkları güvenle taşıma imkanı sunar.
[^thanks-hop]: [Hop Exchange](https://hop.exchange/)’in kullanıcı arayüzünden forklanmıştır 🙌

Yatırımların Scroll üzerinde kullanılabilir hale gelmesi için en fazla 15 dakika sürebilir.

Çekimler, çekimin tamamlanmasından sonra Sepolia'da ikinci bir etkileşim gerektirdiğinden, çok daha uzun sürebilir.

:::caution[Köprü işlemi için uzun süredir bekliyor musunuz?]
Yukarıdaki zaman tahminleri, normal ağ davranışı ve etkinlik seviyeleri için tipiktir. Çünkü L2 bloğunda sıralı L1 işlemlerini sınırlı sayıda işlediğimizden, köprülenen mesajların, olağanüstü ağ kullanımı zamanlarında Scroll'de dahil edilmesi daha uzun sürebilir.
:::

## Sepolia'dan Scroll Sepolia'ya Yatırım

### Talimatlar

1. İlk olarak, [Scroll Bridge](https://sepolia.scroll.io/bridge)'ne gidin ve "Cüzdanı Bağla" düğmesine basın.
...
1. Sepolia'dan Scroll Sepolia'ya transfer etmek istediğiniz tokeni seçin. İlk kez köprü kuruyorsanız, "ETH"yi deneyin.
1. Eğer belirli bir ERC20 tokenini ilk kez transfer ediyorsanız, Sepolia Köprü sözleşmesine ERC20 tokeninize erişim izni vermek için **Onayla**'yı seçmelisiniz.
1. Ardından, yatırım yapmak için **Scroll Sepolia'ya Gönder** düğmesine tıklayın. Cüzdanınız transfer işlemini onaylamanızı isteyecektir.
...
### Tokenlarınızın Scroll Sepolia cüzdanınıza ne zaman ulaşır?
...
## Scroll Sepolia'dan Sepolia'ya Çekim Yapma

### Talimatlar

#### İlk Çekim İşleminizi Gönderme

1. İlk olarak, cüzdanınızda **Scroll Sepolia** ağına geçin.
1. Uygulamada, **Scroll Sepolia**'nın en üstte ve **Ethereum Sepolia**'nın en altta olduğundan emin olun. Pozisyonlarını değiştirmek için "**↓**" düğmesine tıklayabilirsiniz.
1. **Scroll Sepolia**'dan **Sepolia**'ya aktarmak istediğiniz tokeni seçin. İlk kez köprü kuruyorsanız, "ETH"yi deneyin.
1. Eğer belirli bir ERC20 tokenini ilk kez transfer ediyorsanız, Scroll Sepolia Köprü sözleşmesine ERC20 tokeninize erişim izni vermek için **Onayla**'yı seçmelisiniz.
1. Ardından, çekim yapmak için **Ethereum Sepolia'ya Gönder** düğmesine tıklayın. Cüzdanınız transfer işlemini onaylamanızı isteyecektir.
...
1. Çekim işleminiz Ethereum Sepolia'da tamamlandığında, Son İşlemler alanında "Talep Et" düğmesinin dolgu rengine dönüştüğünü göreceksiniz.
...
:::tip[Rollup Durumu]
Rollup durumu `Kesinleştirildi`, bu bloktaki işlemlerin doğru bir şekilde yürütülmesinin Sepolia üzerinde bir geçerlilik kanıtının doğrulanmasıyla kanıtlandığını belirtir. Rollup durumu hakkında daha fazla bilgi için [Scroll Mimarisi Genel Bakış](/tr/technology)'a bakın.
:::
