...
excerpt: "Sepolia Testnet'imizi denediğiniz için teşekkür ederiz. Sepolia Testnet, Ethereum'un Sepolia Testnet'i ve Scroll Sepolia test ağını içerir."
whatsnext: { "Cüzdanınızı Kurun": "/tr/user-guide/setup" }
---

import Aside from "../../../../components/Aside.astro"

<Aside type="tip" title="Mainnet aktif!">
...
Scroll Sepolia Testneti'ni denediğiniz için teşekkür ederiz. Sorularınız varsa veya geri bildirimde bulunmak istiyorsanız, [Discord](https://discord.gg/scroll)'umuza katılın!

Sepolia Testneti, _Ethereum'un Sepolia test ağı_ ve _Scroll Sepolia test ağından_ oluşur. Sepolia, bir Ethereum test ağı iken, Scroll Sepolia, öncekinin üstüne kurulmuş bir sıfır bilgi rollup test ağıdır. Önceden dağıtılmış bazı demo uygulamaları bulunmaktadır: _Sepolia_ ile _Scroll Sepolia_ arasında bir [köprü](https://sepolia.scroll.io/bridge),[^1] _Scroll Sepolia_ için bir [blok gezgini](https://sepolia-blockscout.scroll.io/),[^2] ve bir [rollup gezgini](https://sepolia.scroll.io/rollupscan).
