...
excerpt: "Sepolia Testnet'imizi denediğiniz için teşekkür ederiz. Sepolia Testnet, Ethereum'un Sepolia Testnet'i ve Scroll Sepolia Testnet'i içerir."
...
Scroll'in ana ağı aktif durumda, ancak gerçek fonlar kullanmadan Scroll'ü denemek isteyenler için bu kılavuzu sağlıyoruz.

Scroll ana ağını denemek istiyorsanız kılavuzu takip edin, ardından kenar çubuğundaki ana ağ bağlantılarını kullanın.

</Aside>

Scroll Sepolia Testnet'i denediğiniz için teşekkür ederiz. Sorularınız varsa veya geri bildirimde bulunmak istiyorsanız, [Discord](https://discord.gg/scroll)'umuza katılın!

Sepolia Testnet, _Ethereum'un Sepolia Testnet_ ve _Scroll Sepolia Testnet'ten_ oluşur. Sepolia, bir Ethereum test ağı iken, Scroll Sepolia, öncekinin üstüne kurulmuş bir sıfır bilgi rollup(zk rollup) test ağıdır. Önceden dağıtılmış bazı demo uygulamaları bulunmaktadır: _Sepolia_ ile _Scroll Sepolia_ arasında bir [köprü](https://sepolia.scroll.io/bridge),[^1] _Scroll Sepolia_ için bir [blok gezgini](https://sepolia-blockscout.scroll.io/),[^2] ve bir [rollup gezgini](https://sepolia.scroll.io/rollupscan).

L1 işlemlerini görüntülemek için Etherscan'in [Sepolia gezgini](https://sepolia.etherscan.io/). 
L2 işlemlerini görüntülemek için [Scrollscan](https://sepolia.scrollscan.com) veya Scroll'ün [Blockscout](https://sepolia-blockscout.scroll.io/)'unu kullanabilirsiniz, ancak ayrıca [Dora](https://www.ondora.xyz/network/scroll-sepolia/interactions) veya [L2Scan](https://scroll-sepolia.l2scan.co/)'in sağladığı ek işlevleri de denemek isteyebilirsiniz.

Testnet'i keşfetmek için önerilen iş akışı aşağıdaki gibidir:

1. Cüzdanınıza [Sepolia Testnet](https://sepolia.scroll.io/portal) yapılandırmalarını ekleyin
