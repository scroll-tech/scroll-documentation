...
excerpt: "Sepolia Test ağımızı denediğiniz için teşekkür ederiz. Sepolia Ağı, Ethereum Sepolia Test ağını ve Scroll Sepolia Test ağını içerir."
...
Scroll'in ana ağı aktif durumda, ancak gerçek fonlar kullanmadan Scroll'ü denemek isteyenler için bu kılavuzu oluşturduk.

Scroll ana ağını denemek istiyorsanız kılavuzu takip edin, ardından kenar çubuğundaki ana ağ bağlantılarını kullanın.

</Aside>

Scroll Sepolia Test ağını denediğiniz için teşekkür ederiz. Sorularınız varsa veya geri bildirimde bulunmak istiyorsanız, [Discord](https://discord.gg/scroll)'umuza katılın!

Sepolia Test ağı, _Ethereum Sepolia Testnet_ ve _Scroll Sepolia Testnet'ten_ oluşur. Sepolia, bir Ethereum test ağıdır; Scroll Sepolia ise, bu test ağının üstüne kurulmuş bir sıfır bilgi rollup(zk rollup) test ağıdır. Önceden dağıtılmış bazı demo uygulamalar bulunmaktadır: _Sepolia_ ile _Scroll Sepolia_ arasında bir [köprü](https://sepolia.scroll.io/bridge),[^1] _Scroll Sepolia_ için bir [blok gezgini](https://sepolia-blockscout.scroll.io/),[^2] ve bir [rollup gezgini](https://sepolia.scroll.io/rollupscan).
