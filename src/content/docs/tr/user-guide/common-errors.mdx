...
MetaMask cüzdanınızda depolanan yerel nonce, Scroll testnet düğümündeki nonce'tan farklı olduğunda bu hatayla karşılaşırsınız. Bunun nedeni yakın zamanda bekleyen bir işleminiz olması olabilir.
