...
Bu hatayla karşılaşma sebebiniz MetaMask cüzdanınızda saklanan yerel nonce ile Scroll test ağı düğümündeki nonce'ın farklı olmasıdır. Bu, son zamanlarda bekleyen bir işleminiz olabileceğinden kaynaklanabilir.
...
2. Üst bölgede **Scroll Sepolia Test ağını** seçin
...
Eğer hata veya konsol kayıtları görünmüyorsa, büyük ihtimalle bir nonce sorunu vardır. Lütfen MetaMask hesabınızı yukarıda belirtilen şekilde [sıfırlayın](/tr/user-guide/common-errors).
