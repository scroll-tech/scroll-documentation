...
<Aside type="danger" title="">
  Denetimler güvenlik açıklarının bulunmadığını garanti etmez. Blok zincirlerini kullanmak risk taşır ve Scroll da bir istisna değildir. Kullanıcılara protokolü dikkatli ve riskleri kendilerine ait olacak şekilde kullanmalarını öneriyoruz.
</Aside>
...
- OpenZeppelin ve Zellic köprü ve toplama sözleşmelerimizde bağımsız denetimler gerçekleştirdi
...
Hata ödül programının kapsamı, blockchain altyapısını ve köprüleme ve toplamaya yönelik akıllı sözleşmeleri kapsıyor. Hata kategorilerinin ayrıntılı bir dökümü için lütfen hata ödülü sayfasına bakın.
