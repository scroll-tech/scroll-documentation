...
- Dal Düğümü (Branch Node): zkTrie'nin ikili bir ağaç olduğu göz önüne alındığında, bir dal düğümünün iki çocuğu vardır.
- Yaprak Düğümü (Leaf Node): Bir yaprak düğümü, bir anahtar/değer çiftinin verilerini tutar.
- Boş Düğüm (Empty Node): Boş bir düğüm, aynı öneki paylaşan alt grubun boş olduğunu belirten özel bir düğüm türüdür.
