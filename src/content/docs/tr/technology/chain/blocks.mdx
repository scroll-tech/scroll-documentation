...
Blok, kendinden önceki bloğu devam ettirmeye yönelik işlemler ve bağlantılardan oluşan bir koleksiyondur.
...
| `logsBloom`         | Olay günlüklerini içeren veri yapısı.                          |
| `difficulty`        | Her zaman 1 veya 2'dir.                                                     |
| `number`            | Blok numarası.                                                  |
| `gasLimit`          | Blokta izin verilen maksimum gaz.                              |
| `gasUsed`           | Blokta kullanılan gaz.                                         |
...
Blok süresi ardışık iki blok arasındaki süreyi ifade eder. Scroll'da blok süresi 3 saniyeye ayarlanmıştır. Kısaltılmış blok süresi kullanıcı deneyimini artırır ve Scroll zincirinin ölçeklenebilirliğini artırır.
